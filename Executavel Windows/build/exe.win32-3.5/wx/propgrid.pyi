...
class PGProperty(wx.Object):
    ...
    def ChildChanged(self, thisValue, childIndex, childValue):
        """
        ChildChanged(thisValue, childIndex, childValue) -> Variant
    ...
    def GetAttributes(self):
        """
        GetAttributes() -> PGAttributeStorage
    ...
    AttributesAsList = property(None, None)
    BaseName = property(None, None)
    ...
    DefaultValue = property(None, None)
    DisplayedString = property(None, None)
    EditorClass = property(None, None)
    EditorDialog = property(None, None)
    Flags = property(None, None)
    Grid = property(None, None)
    GridIfDisplayed = property(None, None)
    HelpString = property(None, None)
    IndexInParent = property(None, None)
    Label = property(None, None)
    LastVisibleSubItem = property(None, None)
    MainParent = property(None, None)
    MaxLength = property(None, None)
    ...
    ValueImage = property(None, None)
    ValueString = property(None, None)
    ValueType = property(None, None)
...
class PGVIterator(ObjectRefData):
    """
    PGVIterator()
    PGVIterator(it)
    """
...
class PropertyGridPageState(object):
    ...
    def DoGetPropertyValues(self, listname, baseparent, flags):
        """
        DoGetPropertyValues(listname, baseparent, flags) -> Variant
        """
...
class PropertyGridInterface(object):
    ...
    def GetPropertyAttribute(self, id, attrName):
        """
        GetPropertyAttribute(id, attrName) -> Variant
    ...
    def GetPropertyClientData(self, id):
        """
        GetPropertyClientData(id) -> void
    ...
    def GetPropertyValues(self, listname=wx.EmptyString, baseparent=None, flags=0):
        """
        GetPropertyValues(listname=wx.EmptyString, baseparent=None, flags=0) -> Variant
        
        Returns a wxVariant list containing wxVariant versions of all property
        values.
        """
    ...
    def SetPropertyClientData(self, id, clientData):
        """
        SetPropertyClientData(id, clientData)
    ...
    def SetPropertyValues(self, *args, **kw):
        """
        SetPropertyValues(list, defaultCategory=NullProperty)
        SetPropertyValues(list, defaultCategory=NullProperty)
    ...
    Iterator = property(None, None)
    PropertyValues = property(None, None)
    SelectedProperties = property(None, None)
    Selection = property(None, None)
...
class PropertyGrid(wx.Control, PropertyGridInterface):
    ...
    def GetUncommittedPropertyValue(self):
        """
        GetUncommittedPropertyValue() -> Variant
...
class MultiChoiceProperty(PGProperty):
    """
    MultiChoiceProperty(label, name, strings, value)
