...
class TabConfig(wx.lib.scrolledpanel.ScrolledPanel):
    ...
    def OnEnterFocus(self, e):
        try:
            if self.parent.parent.ultimoDrawSelected.visionOption == Vars.VISION_Z_PERSP:
            ...
            elif self.parent.parent.ultimoDrawSelected.visionOption == Vars.VISION_X_POS :
            ...
            elif self.parent.parent.ultimoDrawSelected.visionOption == Vars.VISION_X_NEG:
                self.parent.parent.ultimoDrawSelected.orthoCenter = (
                -float(self.txtFocusY.GetValue()), -float(self.txtFocusZ.GetValue()))
                self.txtFocusX.SetValue("0")
            elif self.parent.parent.ultimoDrawSelected.visionOption == Vars.VISION_Y_POS :
            ...
            elif self.parent.parent.ultimoDrawSelected.visionOption == Vars.VISION_Y_NEG:
                self.parent.parent.ultimoDrawSelected.orthoCenter = (
